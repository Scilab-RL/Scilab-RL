...
class TestingAlgos:
    ...
    def get_mbchac_performance_params(env):
        ...
        model = 'sac'
        plot_col_names_template = 'train_##/actor_loss,train_##/critic_loss,train_##/ent_coef,train_##/n_updates,test_##/ep_success,test_##/ep_reward,train_##/ent_coef_loss,rollout_##/success_rate,test_##/q_mean,test_##/ep_length,rollout_##/ep_length,test_##/step_success'
