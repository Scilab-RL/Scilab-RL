...
from util.custom_eval_policy import evaluate_policy
...
class EvalCallback2(EventCallback):
    ...
    def __init__(
        ...
        self.render = render
        self.warn = warn
        self.metric_viz = metric_viz_callback
    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            self._is_success_buffer = []
            self.metric_viz._on_rollout_start()
