...
click.option('--hindsight_sampling_done_if_success', type=int, default=0, help='Whether to consider an episode as done *in hindsight* during goal replay if the hindsight goal has been achieved. This is important e.g. in SAC, where the discounted expected return is set to 0 of an episode is done.'),
